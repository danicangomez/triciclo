...
#En este caso al tomar las aristas cada nodo lleva asociado el grafo del que proviene
...
# Teniendo un nodo y su lista de adyacencia genereamos su lista asociada
